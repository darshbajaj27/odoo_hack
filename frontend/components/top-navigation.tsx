...
export function TopNavigation({ currentView, userName, onNavigate, onLogout }: TopNavigationProps) {
  ...
  return (
    <>
      {/* Top Navigation Bar */}
      <header className="sticky top-0 z-40 bg-white dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800 h-16 shadow-sm">
          ...
          <nav className="hidden md:flex items-center gap-1 flex-1 mx-8">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                isActive("dashboard")
                  ? "text-[#714B67] bg-purple-50 dark:bg-purple-950 border-b-2 border-[#714B67]"
            ...
            >
              <button
                className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  desktopOperationsHover
                    ? "text-[#714B67] bg-purple-50 dark:bg-purple-950"
                    : "text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-800"
                }`}
              >
                Operations
              ...
              {/* Dropdown Menu */}
              {desktopOperationsHover && (
                <div className="absolute top-full left-0 mt-0 w-56 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-md shadow-lg py-2">
                  {operationsItems.map((item) => (
                    <button
                      key={item.label}
                      onClick={() => handleNavigate(item.view)}
                      className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-slate-800 hover:text-[#714B67] transition-colors"
                    >
                      {item.label}
                    </button>
                  ))}
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="fixed top-16 left-0 right-0 z-40 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 md:hidden shadow-lg">
            <div className="p-4 space-y-2">
              {/* Dashboard */}
              <button
                onClick={() => handleNavigate("dashboard")}
                className={`w-full text-left px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  isActive("dashboard") ? "text-[#714B67] bg-purple-50 dark:bg-purple-950" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
                }`}
              >
                Dashboard
              </button>
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-md transition-colors"
                >
                  Operations
                  ...
                  <div className="pl-4 mt-1 space-y-1">
                    {operationsItems.map((item) => (
                      <button
                        key={item.label}
                        onClick={() => handleNavigate(item.view)}
                        className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-slate-800 hover:text-[#714B67] rounded-md transition-colors"
                      >
                        {item.label}
                      </button>
                    ))}
              ...
              <button
                onClick={() => handleNavigate("products")}
                className={`w-full text-left px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  isActive("products") ? "text-[#714B67] bg-purple-50 dark:bg-purple-950" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
                }`}
              >
                Stock
              </button>
              ...
              <button
                onClick={() => handleNavigate("move-history")}
                className={`w-full text-left px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  isActive("move-history") ? "text-[#714B67] bg-purple-50 dark:bg-purple-950" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
                }`}
              >
                Move History
              </button>
              ...
              <button
                onClick={() => handleNavigate("settings")}
                className={`w-full text-left px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  isActive("settings") ? "text-[#714B67] bg-purple-50 dark:bg-purple-950" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
                }`}
              >
                Settings
              </button>
              ...
              <div className="pt-4 mt-4 border-t border-gray-200 dark:border-slate-700">
                <button
                  onClick={onLogout}
                  className="w-full flex items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-md transition-colors"
                >
                  <LogOut size={18} />
                  Logout
                </button>
